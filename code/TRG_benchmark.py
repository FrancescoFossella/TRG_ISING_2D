# Tensor Renormalization Group applied to a 2D square lattice Ising model
...
def Z_TRG(K, Dcut, no_iter): 
    ...
    for n in np.arange(no_iter): 
        ...
        for r, u, l, d in product(inds_new , inds_new , inds_new , inds_new): T_new[r][u][l][d] = 0
            for a, b, g, w in product(inds, inds, inds, inds):
                T_new[r][u][l][d] += S1[w,a,r]*S2[a,b,u]*S3[b,g,l]*S4[g,w,d]

        D = D_new
        inds = inds_new T = T_new
